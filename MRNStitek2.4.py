...
class LabelPrinterFrame(wx.Frame):
    def __init__(self, parent, title):
        super(LabelPrinterFrame, self).__init__(parent, title=title, size=(400, 260))
    ...
    def InitUI(self):
        ...
        version_label = wx.StaticText(panel, label="Version 2.4")
    ...
    def is_mrn_code(self, mrn_code):
        return mrn_code.isdigit() and len(mrn_code) == 18
